...
import {IProfileDetails, profileDetailsInitValues as initialValues} from '../Empmodel'
      ...
      <div id='kt_account_profile_details' className='collapse show'>
        <form onSubmit={formik.handleSubmit} noValidate className='form'>
          <div className='card-body border-top p-9'>
            ...
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label required fw-bold fs-6'>Emp ID</label>
            ...
            <div className='row mb-6'>
              ...
              <div className='col-lg-8 fv-row'>
                ...
                {formik.touched.cpassword && formik.errors.cpassword && (
                  <div className='fv-plugins-message-container'>
                    <div className='fv-help-block'>{formik.errors.cpassword}</div>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className='row mb-6'>
              ...
              <div className='col-lg-8 fv-row'>
                ...
                >
                  ...
                  <option value='id'>Associate Consultant</option>
                  <option value='msa'>Consultant</option>
                  <option value='ca'>Senior Consultant</option>
                  <option value='cs'>Lead Consultant</option>
                  <option value='da'>Associate Vice President</option>
                  <option value='de'>Vice President</option>
                </select>
                ...
                <div className='form-text'>
                  Please select the designation of the employee
                </div>
              </div>
            </div>
